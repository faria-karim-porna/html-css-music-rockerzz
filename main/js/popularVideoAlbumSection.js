...
const sliderHeight = document.getElementById(
  "album-card-border-id"
).offsetHeight;
const sliderMobileHeight = document.getElementById(
  "album-card-border-mobile-id"
).offsetHeight;

if (device.matches) {
  document.getElementsByClassName(
    "popular-album-slider-section"
  )[0].style.height = sliderMobileHeight * 1.15 + "px";
  ...
  document.getElementsByClassName(
    "popular-album-slider-section"
  )[0].style.height = sliderHeight * 1.15 + "px";
